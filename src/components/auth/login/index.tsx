...
const LoginPage: React.FC<IPropsLogin> = (props: IPropsLogin): JSX.Element => {
    const {setUsername, setPassword, navigate} = props
    return (
        <Fragment>
            ...
            <TextField fullWidth={true} margin='normal' label='Email' variant='outlined' placeholder='Введите ваш email' onChange={(e) => setUsername(e.target.value)}/>
            ...
            <Typography variant='body1' sx={{fontFamily: 'Poppins'}}>
                У вас нет аккаунта? <span className='incitingText' onClick={() => navigate('/register')}>Зарегестрироваться</span>
            </Typography>
        </Fragment>
    );
};
